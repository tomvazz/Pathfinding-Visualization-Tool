...
route and message will be displayed as such.
...
public class Visualizer implements KeyListener{
	...
	*/
	...
	public void gui(JFrame f) {
		...
		restartbtn.setFont(new Font("Wingdings 3", Font.PLAIN, 18));
	...
	public void executeselection(int a, int b) {
		...
		if (menuselection == "restart") {
			for (int c = 0; c < 43; c++) {
				for (int d = 0; d < 27; d++) {
					gridtext[c][d].setFont(new Font("Webdings", Font.PLAIN, 22));
